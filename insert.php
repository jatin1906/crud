...
if(isset($_POST['done'])){
    ...
    // insert quires
    $ins="INSERT INTO `info` ( `First Name`, `Last Name`, `Email`, `Phone Number`, `Gender`, `Address`)
     VALUES ( '$fname', '$lname', '$email', '$phone', '$gender', '$address')";
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container-fluid">
            <a class="navbar-brand" href="insert.php">CRUD</a>
...
if($insert){
    ...
    <strong>Success !</strong> Your data has been Submit .
